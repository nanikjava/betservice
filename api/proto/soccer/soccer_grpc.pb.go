...
// All implementations must embed UnimplementedSoccerServer
...
// UnimplementedSoccerServer must be embedded to have forward compatible implementations.
...
func (UnimplementedSoccerServer) mustEmbedUnimplementedSoccerServer() {}
